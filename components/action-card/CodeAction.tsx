        ...
        <div className="pt-6">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className="rounded-md border-white border-2 h-8 w-8 cursor-pointer text-white text-2xl flex items-center justify-center hover:bg-white hover:text-red-600 transition-colors"
            >
              &times;
            </Button>
          </div>
